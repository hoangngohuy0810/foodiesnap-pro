            ...
            <div className="max-w-3xl mx-auto px-6 py-16">
                ...
                <div className="prose prose-gray max-w-none space-y-8 text-gray-700 leading-relaxed">
                    <section>
                        ...
                        <p>
                            Ảnh Nét ("chúng tôi", "của chúng tôi") cam kết bảo vệ quyền riêng tư của bạn.
                            Chính sách Bảo mật này giải thích cách chúng tôi thu thập, sử dụng, lưu trữ và bảo vệ
                            thông tin cá nhân của bạn khi sử dụng dịch vụ Ảnh Nét tại <strong>anhnet.top</strong>.
                        </p>
                    </section>
